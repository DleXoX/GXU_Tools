...
bool isConnected() {
    std::vector<const char *> hosts = { "www.baidu.com","www.qq.com","www.sina.com.cn","www.163.com","www.126.com","www.sohu.com","www.taobao.com","www.jd.com","www.tmall.com","www.zhihu.com"};
    // 创建随机数引擎，使用基于时间的种子
    ...
    return (ping(hosts[distrib(gen)],1) == 1) ? true : false;

}
//int ping1(const char* host, int cnt) {
//    static uint16_t seq = 0;
//    uint16_t pid16 = (uint16_t)getpid();
//    char ip[64] = { 0 };
